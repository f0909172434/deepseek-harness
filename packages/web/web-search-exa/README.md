...
- **Only the portable domain allowlist is promoted from Exa's search filters** — livecrawl, category, date filters, domain blocklists, and full-text contents wait on provider-neutral Service Definition fields ([seam Agent Note](../../../.agents/notes/implemented/architecture/2026-06-24-web-capability-seam.md)).
